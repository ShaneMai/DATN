...
class m_customer extends database
{
    ...
    function insert_customer($ten_khach_hang, $gioi_tinh, $ngay_sinh, $dia_chi, $dien_thoai, $email, $ghi_chu)
    {
    ...
    function add_detail_invoice($so_hoa_don, $ma_san_pham, $so_luong, $don_gia)
    {
    ...
    function update_product_price($ma_san_pham)
    {
    ...
    function update_total_price($so_hoa_don)
    {
