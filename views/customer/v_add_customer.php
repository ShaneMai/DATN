<section id="content">
    <div class="main" style="min-height:768px">
        <div class="container">
            ...
            <form name="add_customer" action="customer.php?key=dat-hang" method="post">
                <table align="center" width="90%" cellpadding="2px" cellspacing="0">
                    ...
                    <tr>
                        <td align="center">Giới tính<br/>Nam&nbsp;&nbsp;<input  name="gioi_tinh"  type="radio" value="1" checked="true" />&nbsp;&nbsp;&nbsp;&nbsp;Nữ&nbsp;&nbsp;<input  name="phai"  type="radio" value="0" /></td>
                    </tr>
                    <tr>
